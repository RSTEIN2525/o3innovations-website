...
export function CTASection() {
  return (
    <div className="text-center">
      ...
      >
        Your Dream Website Is Just Hours Away
      </motion.h2>
      ...
      >
        Every minute without a high-performing website costs you leads, sales, and credibility.
        Spots for custom builds are filling fast—secure yours today!
      </motion.p>
