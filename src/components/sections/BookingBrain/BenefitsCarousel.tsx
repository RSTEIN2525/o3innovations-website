...
const benefits = [
  {
    ...
    description: "AI optimizes your calendar automatically",
    details: "Maximum efficiency, zero conflicts"
  },
  {
    title: "Automated Reminders",
    description: "Reduce no-shows by 95%",
    details: "Smart follow-ups that keep clients on track"
  },
  {
    title: "24/7 Availability",
    description: "Book appointments any time",
    details: "Never miss another opportunity"
  },
  {
    title: "Calendar Integration",
    description: "Works with your existing tools",
    details: "Seamless sync across all platforms"
  }
];
