...
const problems = [
  {
    ...
    title: "Manual Tasks",
    description: "Hours wasted on repetitive work"
  },
  {
    icon: <XCircle className="w-6 h-6 text-[#3498DB]" />,
    title: "Human Error",
    description: "Costly mistakes in critical processes"
  },
  {
    icon: <DollarSign className="w-6 h-6 text-[#2ECC71]" />,
    title: "High Overhead",
    description: "$5,000+ monthly on manual work"
  },
  {
    icon: <AlertTriangle className="w-6 h-6 text-[#F1C40F]" />,
    title: "Scaling Issues",
    description: "Growth bottlenecked by processes"
  }
];
...
export function ProblemStatement() {
  return (
    <div className="mb-24">
      ...
      >
        Manual Processes Are Killing Your Growth
      </motion.h2>
