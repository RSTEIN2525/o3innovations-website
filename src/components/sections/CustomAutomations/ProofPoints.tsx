...
const results = {
  ...
  features: [
    "Zero Setup: Ready to automate in 24 hours",
    "Full Integration: Works with your tools",
    "Always Learning: Improves over time"
  ]
};
    ...
    <div className="mb-24">
      ...
      >
        ...
        <p className="text-white/60">
          Join hundreds of businesses automating their operations
        </p>
      </motion.div>
