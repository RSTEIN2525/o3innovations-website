...
const benefits = [
  {
    ...
    description: "Every call answered in under 1 second",
    details: "No more missed calls or frustrated customers"
  },
  {
    title: "Smart Routing",
    description: "Calls directed to the right person",
    details: "Efficient handling of every inquiry"
  },
  {
    title: "24/7 Availability",
    description: "Never miss another opportunity",
    details: "Full coverage without the staffing costs"
  },
  {
    title: "Automated Booking",
    description: "Seamless appointment scheduling",
    details: "Integration with your calendar system"
  }
];
