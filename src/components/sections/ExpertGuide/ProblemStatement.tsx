...
const problems = [
  {
    ...
    description: "Customers bounce when they wait for answers"
  },
  {
    icon: <XCircle className="w-6 h-6 text-[#3498DB]" />,
    title: "No Additional Sales Routing",
    description: "Support should guide customers not frustrate them"
  },
  {
    icon: <DollarSign className="w-6 h-6 text-[#2ECC71]" />,
    title: "High Costs",
    description: "$20,000+ annual cost for a small support team"
  },
  {
    icon: <AlertTriangle className="w-6 h-6 text-[#F1C40F]" />,
    title: "Lost Revenue",
    description: "Missed sales and mounting opportunity costs"
  }
];
...
export function ProblemStatement() {
  return (
    <div className="mb-24">
      ...
      >
        The Real Problem: Your Support Is Letting You Down
      </motion.h2>
