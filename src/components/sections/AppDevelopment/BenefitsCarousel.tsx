...
const benefits = [
  {
    ...
    description: "Smart systems that scale automatically",
    details: "No more server management headaches"
  },
  {
    title: "Rapid Development",
    description: "From concept to live in days",
    details: "10x faster than traditional development"
  },
  {
    title: "Enterprise Security",
    description: "Bank-grade protection built-in",
    details: "Fully compliant and always secure"
  },
  {
    title: "Future-Proof Tech",
    description: "Always up-to-date architecture",
    details: "No technical debt or legacy issues"
  }
];
