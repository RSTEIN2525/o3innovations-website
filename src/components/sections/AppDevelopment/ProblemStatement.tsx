...
const problems = [
  {
    ...
    description: "6+ months just to launch MVP"
  },
  {
    icon: <XCircle className="w-6 h-6 text-[#3498DB]" />,
    title: "Budget Overruns",
    description: "68% of projects exceed budget"
  },
  {
    icon: <DollarSign className="w-6 h-6 text-[#2ECC71]" />,
    title: "High Costs",
    description: "$250K+ for basic applications"
  },
  {
    icon: <AlertTriangle className="w-6 h-6 text-[#F1C40F]" />,
    title: "Technical Debt",
    description: "Outdated before launch"
  }
];
