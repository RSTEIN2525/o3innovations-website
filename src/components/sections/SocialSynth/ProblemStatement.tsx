...
const problems = [
  {
    ...
    description: "Hours wasted on content creation daily"
  },
  {
    icon: <XCircle className="w-6 h-6 text-[#3498DB]" />,
    title: "Inconsistent Results",
    description: "Random engagement and sporadic growth"
  },
  {
    icon: <DollarSign className="w-6 h-6 text-[#2ECC71]" />,
    title: "High Agency Costs",
    description: "$3,000+ monthly for basic management"
  },
  {
    icon: <AlertTriangle className="w-6 h-6 text-[#F1C40F]" />,
    title: "Missed Opportunities",
    description: "Limited posting during peak hours"
  }
];
