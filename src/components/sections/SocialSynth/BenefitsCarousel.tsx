...
const benefits = [
  {
    ...
    description: "AI generates trending posts automatically",
    details: "Never worry about what to post again"
  },
  {
    title: "Smart Scheduling",
    description: "Posts when your audience is most active",
    details: "Maximum engagement, minimum effort"
  },
  {
    title: "Analytics Dashboard",
    description: "Track growth and optimize performance",
    details: "Data-driven insights for better results"
  },
  {
    title: "Multi-Platform Support",
    description: "Manage all social accounts in one place",
    details: "Unified control across all platforms"
  }
];
